...
public class LinkGameExplain8Adapter extends BaseAdapter {

    Context context;
    List<HeightwordReviewBean._$8Bean> mDatas;
    int selectItem = -1;

    public LinkGameExplain8Adapter(Context context, List<HeightwordReviewBean._$8Bean> mDatas) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        HeightwordReviewBean._$8Bean resultBean = mDatas.get(i);
