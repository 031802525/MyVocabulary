...
public class UpdatedetailActivity extends AppCompatActivity implements View.OnClickListener {
...
//                        + MediaStore.Images.Media.EXTERNAL_CONTENT_URI);//   content://media/external/images/media
            ...
            case R.id.btn_takephoto://调用相机拍照
                ...
                try {
                    ...
                    Toast.makeText(UpdatedetailActivity.this, "相机无法启动，请先开启相机权限", Toast.LENGTH_LONG).show();
                }
                break;
            default:
                break;
